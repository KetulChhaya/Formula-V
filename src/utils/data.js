...
export const loadData = async () => {
  ...
  const status = await d3.csv("/data/status.csv");

  return { drivers, races, lapTimes, qualifying, results, pitStops, circuits, constructors, seasons, driver_standings, status };
};
